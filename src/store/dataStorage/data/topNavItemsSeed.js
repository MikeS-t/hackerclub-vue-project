export const topNavItems =
  { items:
    [
      {icon: 'where_to_vote', title: 'Услуги', link: '/services'},
      {icon: 'videogame_asset', title: 'Игри', link: '/games'},
      ...
      {icon: 'sentiment_satisfied_alt', title: 'За нас', link: '/services/sdfdfddfghcvddgtsgh/'},
